...
impl Groth16Verifier {
    /// Verifies a Groth16 proof over BN254 using Soroban's native BN254 host
    ...
    pub fn verify_proof(
        ...
        // Compute the pairing: e(-A, B) * e(alpha, beta) * e(vk_x, gamma) * e(C, delta) == 1
        let neg_a = -proof.a;
